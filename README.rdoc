...
# Configuration
* Enter all the users you want to have in the app as rows in a CSV file (follow the plain "name,email" format as in users_dsgn425.csv in the example). Make sure this CSV contains ONLY the users you want to be notified of account creation, and be cognoscent of the environment this instance is going to be run in - locally or in production (heroku)? This may determine how real you want to go with user creation.
