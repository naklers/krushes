...
* Make sure this CSV contains ONLY the users you want to be notified of account creation, and be cognoscent of the environment this instance is going to be run in - locally or in production (heroku)? This may determine how real you want to go with user creation.
